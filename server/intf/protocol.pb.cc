...
const ::google::protobuf::uint32 TableStruct_protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::FileTransport::send_filecontent_request, idx_),
  PROTOBUF_FIELD_OFFSET(::FileTransport::send_filecontent_request, pieces_),
...
void generalinfo_request::SerializeWithCachedSizes(
  ...
  // required uint64 fileLength = 2;
  if (cached_has_bits & 0x00000004u) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt64(2, this->filelength(), output);
  }
  ...
  if (cached_has_bits & 0x00000008u) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(4, this->pieces(), output);
  }
...
::google::protobuf::uint8* generalinfo_request::InternalSerializeWithCachedSizesToArray(
  ...
  // required uint64 fileLength = 2;
  if (cached_has_bits & 0x00000004u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt64ToArray(2, this->filelength(), target);
  }
  ...
  // required uint32 pieces = 4;
  if (cached_has_bits & 0x00000008u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(4, this->pieces(), target);
  }
...
class send_filecontent_request::HasBitSetters {
 public:
  static void set_has_idx(send_filecontent_request* msg) {
    msg->_has_bits_[0] |= 0x00000002u;
  }
  static void set_has_pieces(send_filecontent_request* msg) {
    msg->_has_bits_[0] |= 0x00000004u;
  }
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int send_filecontent_request::kIdxFieldNumber;
const int send_filecontent_request::kPiecesFieldNumber;
...
send_filecontent_request::send_filecontent_request(const send_filecontent_request& from)
  ...
  ::memcpy(&idx_, &from.idx_,
    ...
    reinterpret_cast<char*>(&idx_)) + sizeof(crc32_));
...
void send_filecontent_request::SerializeWithCachedSizes(
  ...
  // required uint32 pieces = 2;
  if (cached_has_bits & 0x00000004u) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(2, this->pieces(), output);
  }
...
::google::protobuf::uint8* send_filecontent_request::InternalSerializeWithCachedSizesToArray(
  ...
  // required uint32 pieces = 2;
  if (cached_has_bits & 0x00000004u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(2, this->pieces(), target);
  }
