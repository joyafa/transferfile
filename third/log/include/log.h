...
#define LOG_INIT(path)               LOG::Log::GetInstance()->Init(path);
#define LOG_DEBUG(format, ...)       LOG::Log::GetInstance()->Logging(LOG::LogFile::LogLevel::LogDebug, format, ##__VA_ARGS__)
#define LOG_INFO(format, ...)        LOG::Log::GetInstance()->Logging(LOG::LogFile::LogLevel::LogInfo, format, ##__VA_ARGS__)
#define LOG_WARNNING(format, ...)    LOG::Log::GetInstance()->Logging(LOG::LogFile::LogLevel::LogWarnning, format, ##__VA_ARGS__)
#define LOG_ERROR(format, ...)       LOG::Log::GetInstance()->Logging(LOG::LogFile::LogLevel::LogFatal, format, ##__VA_ARGS__)
