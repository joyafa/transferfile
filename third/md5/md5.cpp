...
int main(int argc, char** argv)
{
	...
	clock_t c = clock();
	string strMd5 = md5(std::string(cstring));
	cout << "Md5(string " << cstring << "):" << strMd5 << ":" << clock() -c <<"ms" <<endl;
	c = clock();
    strMd5 = md5(cstring, strlen(cstring));
    cout << "Md5(cstring " << cstring << "):" << strMd5 << ":" << clock() -c <<"ms" <<endl;
    c = clock();
    strMd5 = md5sum6(std::string(cstring));
	cout << "md5sum6(string " << cstring << "):" << strMd5 << ":" << clock() -c <<"ms"  <<endl;
	c = clock();
    strMd5 = md5sum6(cstring, strlen(cstring));
    cout << "md5sum6(cstring " << cstring << "):" << strMd5 <<  ":" << clock() -c <<"ms"  <<endl;
    c = clock();
	strMd5 = md5file("ZoomIt.zip");
    cout << "Md5(FileName " << cstring << "):" << strMd5 <<  ":" << clock() -c <<"ms"  <<endl;
	c = clock();
	std::FILE* file = std::fopen("ZoomIt.zip", "rb");
	cout << "Md5(File*):" << strMd5 <<  ":" << clock() -c <<"ms"  <<endl;
	std::fclose(file);
